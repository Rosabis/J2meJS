  ...
  */
  ...
  function play(isSongLooping) {
    ...
    var reserveSongEndFunc = function reserveSongEndFunc() {
      ...
      var finishTime = _this.getTime(Number_MAX_SAFE_INTEGER);
    ...
    var finishTime = this.getTime(Number_MAX_SAFE_INTEGER);
  ...
  function parseEvent(info) {
    ...
    var lastEventTime = 0; // Midi Events (0x8n - 0xEn) parse
